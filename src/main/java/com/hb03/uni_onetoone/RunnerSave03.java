...
public class RunnerSave03 {
    ...
    public static void main(String[] args) {
        ...
        student2.setId(1002);
        student2.setName("Akın Toprak");
        student2.setGrade(85);


        Student03 student3=new Student03();
        student3.setId(1003);
        student3.setName("Gumsum Hanim");
        ...
        diary2.setId(102);
        diary2.setName("Akın beyin gunlugu");
      ...
      Transaction tx= session.beginTransaction();//bir transaction objesi gonderiyor
